...
import {OFTUpgradeable} from
    "@layerzerolabs/devtools/packages/oft-evm-upgradeable/contracts/oft/OFTUpgradeable.sol";
import {
    OFTCoreUpgradeable,
    MessagingReceipt
} from
    "@layerzerolabs/devtools/packages/oft-evm-upgradeable/contracts/oft/OFTCoreUpgradeable.sol";
import {
    Origin,
    MessagingFee
} from "lib/layerzero-v2/packages/layerzero-v2/evm/oapp/contracts/oapp/OApp.sol";
...
contract ImplementationOFT is OFTUpgradeable {
        ...
        returns (OFTReceipt memory)
    {
        ...
        MessagingReceipt memory msgReceipt =
            _lzSend(sendParam.dstEid, message, extraOptions, fee, msg.sender);
    ...
    {
        (bytes memory _message, bytes memory _extraOptions) =
